...
import HostedReservations from './HostelReservations/HostedReservations';
...
const SideList = ({ open, setOpen }) => {
    ...
    const list = useMemo(
        () => [
            ...
            {
                title: 'Hosted Reservations',
                icon: <EventAvailableIcon />,
                link: 'hostedreservations',
                component: <HostedReservations {...{ setSelectedLink, link: 'hostedreservations' }} />,
            },
            {
                title: 'My Bookings',
                icon: <EventIcon />,
